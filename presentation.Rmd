...
- Reconstruction of SDS user history
- Hunt for SDS data on hard drives and forgotten network storages

\underline{2. Cleaning}

- Repair or documentation of hacks to establish a modern SDS layout
- Merging and harmonising form sheet tables
...
- Host SDS datasets on a server of Kiel University
- Providing functions to download to R
...
- Collecting the information relevant for your research question is enough. 
- Overly complicated databases and documentation systems are not useful.

\underline{Supervision and calibration:}

- Data collection 

\underline{Long-term perspective:}
